...
```powershell
iwr -useb https://raw.githubusercontent.com/aprilslab/obsidian-gitvault-live/main/install.ps1 -OutFile install.ps1
...
curl -fsSL https://raw.githubusercontent.com/aprilslab/obsidian-gitvault-live/main/install.sh | \
...
clone 후 직접:
```bash
git clone https://github.com/aprilslab/obsidian-gitvault-live.git
